...
/**
 * Configuration class for Swagger and OpenAPI documentation in the UserManager application.
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private OpenAPI configureOpenAPI() {
        ...
        server.setDescription("Development server for the User Manager Service API.");

        License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");

        Info info = new Info()
                .title("User Manager Service API")
                .description("API for managing users and related data in the BookStore system.")
                .version("1.0.0")
                .license(mitLicense);
